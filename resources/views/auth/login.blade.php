        ...
        <div class="login_display_02 login_page">
            ...
            <div class="ct_right">
                <div class="ct_right_ct">
                    ...
                    <div class="login_form" id="reset_pass" style="display: none;">

                        <form method="post" accept-charset="utf-8" action="" id="form-login-pass">
                            @csrf
                            ...
                            <div class="form_group" style="display: block;">
                                <div class="list_group">
                                    <input type="text" name="email" autocomplete="off" required=""
                                        placeholder="Địa chỉ Email" id="email" value="{{ old('email') }}">
                                    <figure class="feild_icon"> <i style="color: #bfb9b9" class="fas fa-envelope"></i></figure>
                                    @error('email')
                                    <small class="text-danger mb-2">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                {!! NoCaptcha::renderJs() !!}
                                {!! NoCaptcha::display(['callback' => 'enableSubmitButton']) !!}
                                ...
                                <div class="btn">
                                    <button type="submit" name="button"
                                        class="loginButton loginButtonGg remove-msg before-login disabled_button"
                                        id="submitBtnResetpass" disabled >Cấp lại mật khẩu</button>
                                </div>
                            </div>
                        </form>
                        <div>
...
<script>
    function enableSubmitButton() {
          var submitButton = document.getElementById("submitBtnResetpass");
          console.log("reCAPTCHA completed!");
          if (submitButton) {
              submitButton.disabled = false;  // Bỏ disabled cho nút submit
          }
      }
  </script>

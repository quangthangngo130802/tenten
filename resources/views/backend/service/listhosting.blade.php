    ...
    <div class="content">
                    ...
                    <form action="{{ route('transfer.service') }}" method="POST" id="transferForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="domain">Tên Hosting để đổi:</label>
                            ...
                            <div class="form-group">
                                <label for="toUser">Người nhận Hosting (Người nhận):</label>
        ...
        <div class="category-list">
            ...
            <div class="card-tools d-flex justify-content-end ">
                <a href="{{ route('service.add', ['type' => 'hosting']) }}" class="btn btn-primary btn-sm">Thêm mới (+)</a>
            </div>

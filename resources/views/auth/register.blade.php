...
<div class="container mt-3">
    ...
    <form action="{{ route('submit.register') }}" method="post">
        ...
        <div class="form-group row">
            <label for="username" class="col-sm-4 col-form-label">Tên đăng nhập <span style="color:red"> * </span></label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            <label for="password" class="col-sm-4 col-form-label">Mật khẩu <span style="color:red"> * </span></label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            <label for="full_name" class="col-sm-4 col-form-label">Họ và tên</label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <label class="mr-3"><input type="radio" name="gender" value="male" {{ old('gender') == 'male' ? 'checked' : '' }}> Nam</label>
        ...
        <div class="form-group row">
            <label for="idCard" class="col-sm-4 col-form-label">CMND/CCCD/Hộ chiếu <span style="color:red"> * </span></label>
            <div class="col-sm-8">
                <input type="text" name="identity_number" class="form-control" id="idCard" value="{{ old('identity_number') }}">
                      ...
                      <option value="">Chọn quốc gia</option>
                        @foreach ($quocgia as $item)
                            <option value="{{ $item['countryCode'] }}"
                                {{ old('country') == $item['countryCode'] ? 'selected' : '' }}>
                                {{ $item['countryName'] }}
                            </option>
                        @endforeach
        ...
        <div class="form-group row">
            <label for="province" class="col-sm-4 col-form-label">Tỉnh/Thành phố <span style="color:red"> * </span></label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            <label for="district" class="col-sm-4 col-form-label">Quận/Huyện <span style="color:red"> * </span></label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            <label for="phone_number" class="col-sm-4 col-form-label">Số điện thoại <span style="color:red"> * </span></label>
            <div class="col-sm-8">
